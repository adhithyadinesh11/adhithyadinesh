...
const quickSummary =
    document.querySelector("#quick-summary-lightbox");

const quickSummaryOpen =
    document.querySelector("#quick-summary-open");

const quickSummaryClose =
    document.querySelector("#quick-summary-close");
...
function openQuickSummary(){
    ...
    quickSummary.classList.add("show");
...
function closeQuickSummary(){
    ...
    quickSummary.classList.remove("show");
...
if(quickSummaryOpen){
    ...
    quickSummaryOpen.addEventListener(
        "click",
        openQuickSummary
    );
...
if(quickSummaryClose){
    ...
    quickSummaryClose.addEventListener(
        "click",
        closeQuickSummary
    );
...
if(quickSummary){
    ...
    quickSummary.addEventListener(
        "click",
        event => {

            if(event.target === quickSummary){
...
document.addEventListener(
    ...
    event => {
        ...
        if(
            event.key === "Escape" &&
            quickSummary &&
            quickSummary.classList.contains("show")
        ){
